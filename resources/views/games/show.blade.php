          ...
          <div class="col-xs-12 col-sm-7 col-md-6">
            @if($game->status == 'started')
              <div class="pull-right btn-group">
				<button type="submit" class="btn btn-success" onclick="return confirm('Are you ready for the next {{ $game->time->status == "night" ? "Day" : "Night" }}? You need to make sure you have ticked all the relevant boxes');return false;">Next {{ $game->time->status == 'night' ? 'Day' : 'Night' }} <i class="fa fa-floppy-o"></i></button>
